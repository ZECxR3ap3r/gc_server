...
UAVListener() {
	while(1) {
		if(getNumSurvivors() == 1 && !isdefined(level.radarinuse)) {
        	...
        	UAVINFO.x = 320;
        	UAVINFO.y = 50;
        	UAVINFO.fontscale = 1.4;
    		UAVINFO.font = "objective";
        	UAVINFO.sort = 2;
        	UAVINFO.glowColor = (1, 0, 0);
			UAVINFO.glowAlpha = 1;
        	UAVINFO.foreground = true;
        	UAVINFO settext("^8Last Player Revealed!");
        	...
        	UAVINFOSHADER.x = 320;
        	UAVINFOSHADER.y = 75;
        	UAVINFOSHADER.archived = 1;
        	UAVINFOSHADER.foreground = true;
        	UAVINFOSHADER.color = (1,1,1);
        	UAVINFOSHADER.sort = 2;
        	UAVINFOSHADER setshader("dpad_killstreak_uav", 30, 30);
        	UAVINFOSHADER setPulseFX(1, 100000000, 100000000);
        	wait 3.5; 
