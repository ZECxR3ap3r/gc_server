    ...
    switch(getdvar("ui_mapname")){
		...
		case "mp_hillside_ss":
			level.meat_playable_bounds = [
	         (1152.46, -919.125, 6.92505),
		        ...
		        thread CreateRamps((-1641, -1492, 2266.37),(-1641, -1588, 2338.13));
        ...
        case "mp_paris":
            ...
            if(rnd == 0)
            {
				...
				thread moveac130position((-2735, 1444, 1400));
				...
				thread moveac130position((603, -1585, 1500));
				...
				thread CreateDeathRegion((623, -3068, 12), (61, -3515, -40));
            }
            break;
        case "mp_exchange":
            rnd = randomint(3);
            ...
            if(rnd == 0) {
				...
				thread fufalldamage((-1850, -245, 590.125), 140, 527);
        ...
        case "mp_hardhat":
            ...
            else if(rnd == 1)
            {
				...
				thread moveac130position((-892, -1541, 2000));
        ...
        case "mp_mogadishu":
            ...
            if(rnd == 0)
            {
				...
				thread moveac130position((-985, 445, 2026.13));
            ...
            else if(rnd == 1)
            {
				...
				thread moveac130position((2442, -226, 2018.13));
				...
				thread CreateInvisGrids((1986.6, -1211.9, 30),(1967.4, -1205, 30), (0,341,0));

			    thread CreateRamps((3154, 134, 99),(3060, 134, 70));

				thread CreateWalls((2313, 122, 90),(2553, 122, 170), (0,0,0));
                ...
                thread createTP((2600, 1468, -26.7422), (2388, 1307, -29.5731), (0,270,0), undefined);
                thread createTP((-646, 3168, 92.125), (2388, 1307, -29.5731), (0,270,0), undefined);
                thread createTP((-898, 632, 96.125), (2388, 1307, -29.5731), (0,270,0), undefined);
                thread createTP((262, 1171, -48.7845), (2388, 1307, -29.5731), (0,270,0), undefined);
                thread createTP((915, -54, -47.875), (2388, 1307, -29.5731), (0,270,0), undefined);
            ...
            else if(rnd == 2)
            {
				...
				thread createDeathRegion((-1063.81, 3121, 329), (-1288, 2815.7, 545));
        ...
        case "mp_bravo":
            ...
            else if(rnd == 1)
            {
                ...
                thread createPolygon();
				 ...
				 thread moveac130position((2753, 1424, 3000));
        ...
        case "mp_favela":
            ...
            else if(rnd == 1)
            {
				...
				thread moveac130position((2213, 830, 3366.986));
        ...
        case "mp_plaza2":
            rnd = randomint(2);
				...
				thread moveac130position((-3394, -1562, 4700));
	            ...
	            //Soft Landing
	            thread fufalldamage((-4422, -1023, 736.125),650, 1000);
				...
				thread moveac130position((-551, 3749, 5000));
		...
		rnd = randomint(2);
			...
			thread moveac130position((354, -470, 3000));
			...
			thread moveac130position((-1818, 4772, 4180));

			thread createTP((-1537,1510,30), (-28,2578,0),(0, 90, 0),undefined);
			thread createTP((284,-247,-10), (-28,2578,0),(0, 90, 0),undefined);
			thread createTP((-1774,-406,-10), (170,2589,0),(0, 90, 0),undefined);
			thread createTP((-49,2336,0), (170,2589,0),(0, 90, 0),undefined);
			thread createTP((664,1545,20), (-28,2578,0),(0, 90, 0),undefined);


		   thread createTP((1312,4350.673,-3.875), (-101,3192.81,625.625),(0, 180, 0),1,50,100,40);
		   thread createTP((-323.4,4078.623,-50.875), (-101,3192.81,625.625),(0, 180, 0),1,50,100,40);
		   thread createTP((-275.56, 4397.2, -40.875), (-65,3701.11,625.625),(0, 180, 0),1,50,40,40);

		   //secret tp
		   thread createTP((-294.56,4397.2,-144.875), (-1469.8,3709.71,150),(0, 270, 0),1,20,300,120);

		   thread createTP((-1277, 3967, 838), (-3640.2,3280.4,960),(0, 63, 0),1,40,100,120);
		   thread CreateWalls((-1497, 3712, 900),(-1497, 4233, 900));
		   thread CreateWalls((-1497, 3712, 840),(-1497, 4233, 840));
		   thread CreateWalls((-1497, 4024, 780),(-1497, 4233, 780));
		   thread CreateWalls((-1497, 4129, 720),(-1497, 4233, 720));

		   //late flag spawn
		   thread createTP((-249,3591,-10), (-3640.2,3280.4,960),(0, 63, 0),1,40,100,330);
		   //thread CreateBombsquadGrids((134, 3601, 200),(28, 3601, 200),(-23,0,90));
		  //thread spawncrate((45, 3600, 127),(45,0,90), "com_plasticcase_trap_bombsquad");
         // thread spawncrate((28, 3600, 187),(285,0,90), "com_plasticcase_trap_bombsquad");


			thread createHiddenTP((-6090, 5810, 1160.18), (-2340,1211.47,0), (0,0,0), "out", undefined);

			thread CreateQuicksteps((-3516, 3499, 820), 80, 18, 14, (0,330,0));
			thread CreateQuicksteps((-4692, 4839, 760), 140, 18, 14, (0,340,0));
			thread CreateRamps((-4557, 4789, 631),(-4592, 4803, 643));

		   thread spawncrate((922, 4045, 600), (90, 270, 90));


		thread CreateDeathRegion((255, 2541, -200), (1111, 3909, 156));

		thread CreateInvisWalls((220.824, 2827, 170),(220.824, 2980, 170));

       thread CreateWalls((-309.5, 3546, -4),(-309.5, 3640, 123));

	   thread CreateWalls((-368.8, 4076.8, -40),(-368.8, 4281.8, 70));
	   thread CreateWalls((-276, 4407, -35),(-276, 4619, 95));

	   thread CreateWalls((227.9, 4775.7, 40),(1328, 4775.7, 40));

	   //thread CreateDoors((230.4,3945,10) /*open*/, (70.4,3945,10) /*close*/, (90,90,0) /*angle*/, 4 /*size*/, 3 /*height*/, 20 /*hp*/, 130 /*range*/, true /*sideways*/);

	   thread spawncrate((271, 3240, 410),(90,90,0));
	   thread spawncrate((271, 3920, 410),(90,90,0));

	  thread spawncrate((-82, 3859, 470),(90,350,0), "com_plasticcase_friendly");
	  thread spawncrate((-62, 3963, 470),(90,350,0), "com_plasticcase_friendly");
	  thread spawncrate((-45, 4075, 470),(90,350,0), "com_plasticcase_friendly");

	   thread spawncrate((-25, 4185, 470),(90,350,0), "com_plasticcase_friendly");
	   thread spawncrate((-20, 4295, 470),(90,350,0), "com_plasticcase_friendly");

	   thread spawncrate((9, 4406, 470),(90,350,0), "com_plasticcase_friendly");
	   thread spawncrate((27, 4517, 470),(90,350,0), "com_plasticcase_friendly");

	   thread spawncrate((49.8, 4632.4, 470),(90,342,0), "com_plasticcase_friendly");

       thread CreateRamps((-637, 4045, 705),(-494, 4045, 675));
	   thread CreateRamps((-673, 2742, 690),(-673, 2889, 720));
	   thread spawncrate((-673, 2920, 725),(0,0,0), "com_plasticcase_friendly");
       thread CreateRamps((161, 2734, -23),(161, 2830, 4));

       thread createDeathRegion((-462.3,4744.13,90), (-1121.13,2945.9,200.64));
	   thread createDeathRegion((-936.9,3734.25,90), (-2653.5,4926.4,200.64));
	   thread createDeathRegion((-1864,2699.4,90), (-5196, 7616, 420.64));
	   thread createDeathRegion((-5273, 4377.4,780), (-6962, 6545, 300.64));

       thread createDeathRegion((-379.3,4663.13,157), (-560.13,4795.9,355.64));

	   thread CreateWalls((-3783.6, 3322.5, 940),(-3386.88, 3111.8, 940));
	   thread CreateWalls((-3783.6, 3322.5, 1010),(-3386.88, 3111.8, 1010));


	    thread spawncrate((-3733, 3413, 730),(0,62,0), "com_plasticcase_friendly");
		thread spawncrate((-3706, 3463, 730),(0,62,0), "com_plasticcase_friendly");
		thread spawncrate((-3679, 3513, 730),(0,62,0), "com_plasticcase_friendly");
		thread spawncrate((-3652, 3563, 730),(0,62,0), "com_plasticcase_friendly");
		thread spawncrate((-3625, 3613, 730),(0,62,0), "com_plasticcase_friendly");
		thread spawncrate((-3652, 3627, 730),(0,62,0), "com_plasticcase_friendly");
		thread spawncrate((-3679, 3641, 730),(0,62,0), "com_plasticcase_friendly");
		thread spawncrate((-3706, 3655, 730),(0,62,0), "com_plasticcase_friendly");
		thread spawncrate((-3733, 3669, 730),(0,62,0), "com_plasticcase_friendly");
		thread spawncrate((-3760, 3683, 730),(0,62,0), "com_plasticcase_friendly");
		thread spawncrate((-3787, 3697, 730),(0,62,0), "com_plasticcase_friendly");
		thread spawncrate((-3814, 3711, 730),(0,62,0), "com_plasticcase_friendly");
		thread spawncrate((-3841, 3725, 730),(0,62,0), "com_plasticcase_friendly");
		thread spawncrate((-3868, 3739, 730),(0,62,0), "com_plasticcase_friendly");
		thread spawncrate((-3895, 3753, 730),(0,62,0), "com_plasticcase_friendly");
		thread spawncrate((-3922, 3767, 730),(0,62,0), "com_plasticcase_friendly");
		thread spawncrate((-3949, 3781, 730),(0,62,0), "com_plasticcase_friendly");
		thread spawncrate((-3976, 3795, 730),(0,62,0), "com_plasticcase_friendly");
		thread spawncrate((-4003, 3809, 730),(0,62,0), "com_plasticcase_friendly");
		thread spawncrate((-4030, 3823, 730),(0,62,0), "com_plasticcase_friendly");
		thread spawncrate((-4057, 3837, 730),(0,62,0), "com_plasticcase_friendly");
		thread spawncrate((-4084, 3851, 730),(0,62,0), "com_plasticcase_friendly");
		thread spawncrate((-4111, 3865, 730),(0,62,0), "com_plasticcase_friendly");
		thread spawncrate((-4138, 3879, 730),(0,62,0), "com_plasticcase_friendly");
		thread spawncrate((-4165, 3893, 730),(0,62,0), "com_plasticcase_friendly");
		thread spawncrate((-4192, 3907, 730),(0,62,0), "com_plasticcase_friendly");
		thread spawncrate((-4219, 3921, 730),(0,62,0), "com_plasticcase_friendly");
		thread spawncrate((-4246, 3935, 730),(0,62,0), "com_plasticcase_friendly");
		thread spawncrate((-4273, 3949, 730),(0,62,0), "com_plasticcase_friendly");
		thread spawncrate((-4300, 3963, 730),(0,62,0), "com_plasticcase_friendly");
		thread spawncrate((-4327, 3977, 730),(0,62,0), "com_plasticcase_friendly");
		thread spawncrate((-4354, 3991, 730),(0,62,0), "com_plasticcase_friendly");
		thread spawncrate((-4381, 4005, 730),(0,62,0), "com_plasticcase_friendly");
		thread spawncrate((-4408, 4019, 730),(0,62,0), "com_plasticcase_friendly");
		thread spawncrate((-4435, 4033, 730),(0,62,0), "com_plasticcase_friendly");
		thread spawncrate((-5562, 4047, 730),(0,62,0), "com_plasticcase_friendly");


		thread spawncrate((-3738.9, 3396, 920),(0,62,0), "com_plasticcase_friendly");
	    thread spawncrate((-3765.9, 3346, 920),(0,62,0), "com_plasticcase_friendly");

		 thread spawncrate((-3733, 3413, 773),(90,62,0), "com_plasticcase_friendly");
		  thread spawncrate((-3733, 3413, 830),(90,62,0), "com_plasticcase_friendly");
		  thread spawncrate((-3733, 3413, 888),(90,62,0), "com_plasticcase_friendly");

		  thread spawncrate((-3684, 3313, 931),(0,62,270), "com_plasticcase_friendly");

		  thread CreateWalls((-3592, 3635, 745),(-3542, 3609, 810));
		  thread CreateWalls((-3591, 3651, 745),(-3493, 3827, 810));

		  thread CreateBombsquadWalls((-3019, 3836.6, 890),(-4024, 4419.6, 890));
		  thread spawncrate((-4013, 4412, 875),(305,152,90), "com_plasticcase_trap_bombsquad");
          thread spawncrate((-4013, 4412, 927),(55,152,90), "com_plasticcase_trap_bombsquad");


		  thread CreateBombsquadWalls((-3612, 5270, 1136),(-4335, 5887, 1136));
		  thread CreateBombsquadWalls((-4335, 5887, 1136),(-4510, 5999, 1136));
		  thread spawncrate((-4499, 5995, 1121),(305,152,90), "com_plasticcase_trap_bombsquad");
          thread spawncrate((-4499, 5995, 1173),(55,152,90), "com_plasticcase_trap_bombsquad");
		   ...
		   thread CreateRamps((-4436, 4319, 721),(-4436, 4598, 630));
		   thread CreateRamps((-4813, 5155, 754),(-4660, 5466, 884));
		   thread CreateRamps((-5488, 5245, 1004),(-5230, 5400, 940));
		   thread spawncrate((-5518.5, 5225.9, 1010),(0,121,0), "com_plasticcase_friendly");

		   thread CreateRamps((-5703, 5345, 1004),(-5703, 5670, 1160));


			thread cannonball((-1457, 3120, 230), (0,90,0), (-500,0,1600), 3, (-4281, 5437, 1080), 2100);
			thread cannonball((-4737, 4364, 844), (0,62,0), (0,900,900), 2, (-4281, 5437, 1080), 300);
			thread fufalldamage((-4509, 4962, 630),660, 1000);
			thread fufalldamage((783, 3547, -10),1300, 1000);

			ent = spawn("script_model", (845, 3972, 581));
                ent.angles = (0, 20, 90);
           	    ent setmodel("viewmodel_desert_eagle_gold_mp");
        ...
        case "mp_nuked":
		 ...
		 classicents = GetEntArray("classicinf", "targetname");
            ...
            thread createHiddenTP((49, -15949, -193.18), (-233,-525, -30), (0,90,0), "out", 0, 90, 220);
			thread createTP((-17238,-3176,-35), (46, -17076, 663), (0, 270, 0),0,40,100,20);
			thread createTP((-16932,-3833,-35), (46, -17076, 663), (0, 270, 0),0,40,100,20);
			...
			thread CreateWalls((-16325, -3216, -21),(-16430, -3086, -21));
			thread CreateWalls((-16325, -3216, 45),(-16430, -3086, 45));
			...
			thread CreateWalls((-16501, -3177.4, -26),(-16438, -3260, 86));
			thread CreateWalls((-16767, -2854, -26),(-16669, -2964.4, 86));
        ...
        case "mp_carbon":
			...
			thread moveac130position((-1485, -6573, 5945));
            ...
            thread CreateGrids((-2497, -6535, 4330),(-3200, -6535, 4330),(0,165,90));
            // Spawn roof
        ...
        case "mp_bootleg":
            ...
            if(rnd == 0)
            {
				...
				thread moveac130position((2281, -627, 3222));
				...
				thread createHiddenTP((1613, 664, -110), (-343.66,567.401,-67.875), undefined, "out");
            ...
            {
				thread moveac130position((-2406, -1913, 3333));
        ...
        case "mp_dome":
            ...
            if(rnd == 0)
            {
				...
				thread moveac130position((1492, 3233, 2260));
            ...
            else if(rnd == 1)
            {
				...
				thread moveac130position((2017, -166, 1330));
				...
				thread CreateInvisWalls((1940, 700, -210),(1790, 700, -210));
        ...
        case "mp_underground":
            ...
            if(rnd == 0) {
				...
				thread moveac130position((-2028, 2410, 2070));
                ...
                thread CreateWalls((-2415, 2690, -200),(-2415, 2690, -200),(0,90,90));
				thread CreateWalls((-2415, 2690, -140),(-2415, 2690, -140),(0,90,90));
                //new spawn protection
                thread CreateTrapGrids((-2067, 1110.7, 100),(-1925, 975.5, 100), (0,0,0));
                // carpark big entrance blocker
                thread CreateWalls((-1200, 3905, -120),(-973, 4132, -120));
				thread CreateWalls((-1200, 3905, -60),(-973, 4132, -60));
                // roof to roof ramp
				...
				thread createHiddenTP((-821, 4197, -111), (32, 2949, -249), undefined, "out");
				...
				thread moveac130position((2184, 1050, 1550));


                // TPs
                thread createHiddenTP((565.125,1135.89,174.125), (-737.578,3282.3,-127.875), undefined, "out");
                thread createTP((343.421,2488.08,-148.875), (2169.93, 2971.3, -12.4441), (0,180,0));
                thread createTP((718.752,1720.09,-255.875), (2169.93, 2971.3, -12.4441), (0,180,0));
                thread createTP((-358.152,52.1443,-127.875), (2169.93, 2971.3, -12.4441), (0,180,0));
                thread createTP((422.092,71.6326,-127.875), (2169.93, 2971.3, -12.4441), (0,180,0));
                thread createTP((9.44049,-731.92,0.124999), (2169.93, 2971.3, -12.4441), (0,180,0));
                thread createTP((-1492.52,1897.44,-255.875), (2169.93, 2971.3, -12.4441), (0,180,0));
        ...
        case "mp_nightshift":
            ...
            if(rnd == 0) {
				...
				thread moveac130position((3438, -3668, 3000));
            ...
            else if(rnd == 1)
            {
				...
				thread moveac130position((-1394, 1099, 3000));
                ...
                thread CreateElevator((-1875, 280, 321),(-1985, 250, 321), 232, 1.5,(0,0,0), undefined, (-1875, 280, 553));
			 ...
			 else if(rnd == 2)
            {
				...
				thread moveac130position((-606, -1876, 3700));

				thread spawncrate((139, -1608, 700), (0, 90, 0));
				thread spawncrate((139, -1558, 700), (0, 90, 0));
				thread spawncrate((139, -1249, 700), (0, 90, 0));
                ...
                thread createDeathRegion((-997, -1143, 710), (561, -701, 580));
        ...
        case "mp_terminal_cls":
            ...
            if(rnd == 0)
            {
				...
				thread moveac130position((5295, 2792, 2060));
            ...
            else if(rnd == 1)
            {
				...
				thread moveac130position((3785, 3161, 2875));
				...
				thread createTP((3025, 3500, 192),(3045, 3160, 192), (0,270,0));
                thread createTP((3045, 2888, 192),(3763, 3367, 192), (0,170,0));

				thread createHiddenTP((2975, 4081, 192),(357, 4587, 306), (0,270,0) , "out");

				thread spawncrate((3487.8, 5018, 186), (0, 0, 0), "com_plasticcase_friendly");
				thread spawncrate((3755.7, 4899.8, 186), (0, 90, 0), "com_plasticcase_friendly");
            }
			else if(rnd == 2)
            {
		...
		thread moveac130position((-2117, 3649, 1900));
        ...
        case "mp_courtyard_ss":
            ...
            if(rnd == 0)
            {
				...
				thread moveac130position((-672, -2966, 1960));
            ...
            else if(rnd == 1)
            {
			 ...
			 thread spawncrate((-3639, -2044, -570), (0, 90, 0));
				...
				thread moveac130position((-1688, -3417, 2089));



               ent = spawn("script_model", (363, -4269, 504));
				ent.angles = (0, 13, 0);
				ent setmodel("foliage_tree_oak_2");

					ent = spawn("script_model", (368, -4280, 713));
				ent.angles = (88, 85, 0);
				ent setmodel("afr_ladder_01");

				ent = spawn("script_model", (364, -5250, 714));
				ent.angles = (30, 270, 0);
				ent setmodel("afr_ladder_01");



		        thread fufalldamage((-3664, -3026, -500),530, 770);

				thread CreateInvisWalls((-2910, -3204, -70),(-3413, -3204, -70));
		        thread CreateInvisWalls((-3413, -2875, -70),(-2910, -2875, -70));

				thread spawncrate((-3380, -3204 ,-120), (0,180,90));
				thread spawncrate((-3380, -3204 ,-170), (0,180,90));

				thread spawncrate((-3380, -2875 ,-120), (0,0,90));
				thread spawncrate((-3380, -2875 ,-170), (0,0,90));

				thread CreateInvisWalls((-2883, -2875, -70),(-2883, -3196, -70));

				thread cannonballInvis((167, -5347, 846), (0,325,0), (500,0,900), 3, (-3137, -3043, -50), 900);

				thread spawncrate((221 ,-5386 ,846), (0,325,0));

				 ent = spawn("script_model", (185, -5350, 863));
				ent.angles = (0, 325, 90);
				ent setmodel("wood_plank1");

			    ent = spawn("script_model", (185, -5370, 863));
				ent.angles = (0, 324, 90);
				ent setmodel("wood_plank2");


			    ent = spawn("script_model", (433, -5350, 860));
				ent.angles = (0, 0, 0);
				ent setmodel("aq_brick_tan");


				ent = spawn("script_model", (362, -2798, 760));
				ent.angles = (0, 325, 90);
				ent setmodel("aq_stone_block_04");

		        ent = spawn("script_model", (362, -2752, 730));
				ent.angles = (0, 0, 0);
				ent setmodel("aq_brick_tan_short_02");

				ent = spawn("script_model", (362, -2752, 752));
				ent.angles = (0, 0, 0);
				ent setmodel("aq_brick_tan_short_02");

				ent = spawn("script_model", (362, -2752, 774));
				ent.angles = (0, 0, 0);
				ent setmodel("aq_brick_tan_short_02");

				ent = spawn("script_model", (362, -2752, 795));
				ent.angles = (0, 0, 0);
				ent setmodel("aq_brick_tan_short_01");


				ent = spawn("script_model", (323, -5352, 875));
				ent.angles = (0, 0, 0);
				ent setmodel("aq_stone_block_06");

				ent = spawn("script_model", (287, -5352, 875));
				ent.angles = (0, 0, 90);
				ent setmodel("aq_stone_block_07");

				ent = spawn("script_model", (251, -5352, 875));
				ent.angles = (0, 180, 0);
				ent setmodel("aq_stone_block_06");



				ent = spawn("script_model", (355, -5355, 840));
				ent.angles = (0, 270, 0);
				ent setmodel("aq_stone_block_04");

				ent = spawn("script_model", (355, -5390, 840));
				ent.angles = (0, 90, 0);
				ent setmodel("aq_stone_block_04");

				ent = spawn("script_model", (355, -5430, 840));
				ent.angles = (0, 90, 0);
				ent setmodel("aq_stone_block_04");

				ent = spawn("script_model", (355, -5470, 840));
				ent.angles = (0, 90, 0);
				ent setmodel("aq_stone_block_04");



			   ent = spawn("script_model", (289, -5355, 840));
				ent.angles = (0, 270, 0);
				ent setmodel("aq_stone_block_04");

				ent = spawn("script_model", (289, -5390, 840));
				ent.angles = (0, 90, 0);
				ent setmodel("aq_stone_block_04");

				ent = spawn("script_model", (289, -5430, 840));
				ent.angles = (0, 90, 0);
				ent setmodel("aq_stone_block_04");

				ent = spawn("script_model", (289, -5470, 840));
				ent.angles = (0, 90, 0);
				ent setmodel("aq_stone_block_04");

				ent = spawn("script_model", (289, -5500, 840));
				ent.angles = (0, 90, 0);
				ent setmodel("aq_stone_block_04");

				ent = spawn("script_model", (355, -5500, 840));
				ent.angles = (0, 90, 0);
				ent setmodel("aq_stone_block_04");

				ent = spawn("script_model", (400, -5500, 840));
				ent.angles = (0, 90, 0);
				ent setmodel("aq_stone_block_04");



				ent = spawn("script_model", (411, -5370, 840));
				ent.angles = (0, 0, 0);
				ent setmodel("aq_stone_block_04");

				ent = spawn("script_model", (445, -5370, 840));
				ent.angles = (0, 0, 0);
				ent setmodel("aq_stone_block_04");

				ent = spawn("script_model", (478, -5370, 840));
				ent.angles = (0, 180, 0);
				ent setmodel("aq_stone_block_04");

				ent = spawn("script_model", (411, -5440, 840));
				ent.angles = (0, 0, 0);
				ent setmodel("aq_stone_block_04");

				ent = spawn("script_model", (445, -5440, 840));
				ent.angles = (0, 0, 0);
				ent setmodel("aq_stone_block_04");

				ent = spawn("script_model", (478, -5440, 840));
				ent.angles = (0, 180, 0);
				ent setmodel("aq_stone_block_04");


			    ent = spawn("script_model", (240, -5499, 840));
				ent.angles = (0, 180, 0);
				ent setmodel("aq_stone_block_04");
			    ent = spawn("script_model", (240, -5440, 840));
				ent.angles = (0, 180, 0);
				ent setmodel("aq_stone_block_04");
				ent = spawn("script_model", (240, -5370, 840));
				ent.angles = (0, 0, 0);
				ent setmodel("aq_stone_block_04");



			    ent = spawn("script_model", (359, -5411, 670));
				ent.angles = (0, 180, 90);
				ent setmodel("aq_stone_block_04");
				ent = spawn("script_model", (359, -5411, 740));
				ent.angles = (0, 140, 90);
				ent setmodel("aq_stone_block_04");

				ent = spawn("script_model", (359, -5411, 800));
				ent.angles = (0, 93, 0);
				ent setmodel("aq_stone_block_04");
				...
				ent = spawn("script_model", (364, -5219, 686));
				ent.angles = (0, 93, 270);
				ent setmodel("aq_stone_block_05");
				ent = spawn("script_model", (364, -5250, 686));
				ent.angles = (0, 90, 270);
				ent setmodel("aq_stone_block_05");


				ent = spawn("script_model", (452, -5336, 890));
				ent.angles = (0, 0, 0);
				ent setmodel("ctl_vine_patch_hang");



						ent = spawn("script_model", (493, -5349, 872));
				ent.angles = (0, 0, 4);
				ent setmodel("prop_flag_sas");

			    thread spawncrate((340 ,-5228 ,655), (0,90,0));
			    thread spawncrate((380 ,-5228 ,655), (0,90,0));


				thread spawncrate((365 ,-5230 ,700), (0,90,0));

				thread CreateGrids((466, -5355, 841),(255, -5458, 841), (0,0,0));

				thread CreateGrids((416, -5500, 841),(255, -5500, 841), (0,0,0));

				thread CreateInvisQuicksteps((362, -5340, 828), 150, 16, 8, (0,90,0));

				thread spawncrate((255 ,-5512 ,841), (0,0,0));
                thread spawncrate((314 ,-5352 ,876), (0,0,0));
				thread spawncrate((266 ,-5352 ,876), (0,0,0));

			    thread spawncrate((424 ,-5352 ,865), (0,0,0));
                thread spawncrate((464 ,-5352 ,865), (0,0,0));


			   	thread spawncrate((430 ,-2832 ,760), (0,90,0));
				thread spawncrate((291 ,-2832 ,760), (0,90,0));
			    thread spawncrate((430 ,-2916 ,760), (0,90,0));
				thread spawncrate((291 ,-2916 ,760), (0,90,0));
				thread spawncrate((430 ,-2832 ,810), (0,90,0));
				thread spawncrate((291 ,-2832 ,810), (0,90,0));
			    thread spawncrate((430 ,-2916 ,810), (0,90,0));
				thread spawncrate((291 ,-2916 ,810), (0,90,0));


			    thread spawncrate((340 ,-2822 ,700), (0,90,0));
			    thread spawncrate((380 ,-2822 ,700), (0,90,0));
			    thread spawncrate((340 ,-2890 ,700), (0,90,0));
			    thread spawncrate((380 ,-2890 ,700), (0,90,0));
				thread spawncrate((340 ,-2958 ,700), (0,90,0));
			    thread spawncrate((380 ,-2958 ,700), (0,90,0));
			   	thread spawncrate((340 ,-3026 ,700), (0,90,0));
			    thread spawncrate((380 ,-3026 ,700), (0,90,0));
			    thread spawncrate((340 ,-3094 ,700), (0,90,0));
			    thread spawncrate((380 ,-3094 ,700), (0,90,0));
				thread spawncrate((340 ,-3162 ,700), (0,90,0));
			    thread spawncrate((380 ,-3162 ,700), (0,90,0));
				thread spawncrate((340 ,-3230 ,700), (0,90,0));
			    thread spawncrate((380 ,-3230 ,700), (0,90,0));
                thread spawncrate((340 ,-3298 ,700), (0,90,0));
			    thread spawncrate((380 ,-3298 ,700), (0,90,0));
			    thread spawncrate((340 ,-3366 ,700), (0,90,0));
			    thread spawncrate((380 ,-3366 ,700), (0,90,0));
				thread spawncrate((340 ,-3434 ,700), (0,90,0));
			    thread spawncrate((380 ,-3434 ,700), (0,90,0));
				thread spawncrate((340 ,-3502 ,700), (0,90,0));
			    thread spawncrate((380 ,-3502 ,700), (0,90,0));
			   	thread spawncrate((340 ,-3570 ,700), (0,90,0));
			    thread spawncrate((380 ,-3570 ,700), (0,90,0));
				thread spawncrate((340 ,-3638 ,700), (0,90,0));
			    thread spawncrate((380 ,-3638 ,700), (0,90,0));
				thread spawncrate((340 ,-3706 ,700), (0,90,0), "com_plasticcase_friendly");
			    thread spawncrate((380 ,-3706 ,700), (0,90,0), "com_plasticcase_friendly");
				thread spawncrate((340 ,-3774 ,700), (0,90,0), "com_plasticcase_friendly");
			    thread spawncrate((380 ,-3774 ,700), (0,90,0), "com_plasticcase_friendly");

				thread spawncrate((340 ,-3842 ,700), (0,90,0));
			    thread spawncrate((380 ,-3842 ,700), (0,90,0));

				thread spawncrate((340 ,-3910 ,700), (0,90,0));
			    thread spawncrate((380 ,-3910 ,700), (0,90,0));

				thread spawncrate((340 ,-3978 ,700), (0,90,0));
			    thread spawncrate((380 ,-3978 ,700), (0,90,0));

				thread spawncrate((340 ,-4046 ,700), (0,90,0));
			    thread spawncrate((380 ,-4046 ,700), (0,90,0));

				thread spawncrate((340 ,-4114 ,700), (0,90,0));
			    thread spawncrate((380 ,-4114 ,700), (0,90,0));

				thread spawncrate((340 ,-4182 ,700), (0,90,0), "com_plasticcase_friendly");
			    thread spawncrate((380 ,-4182 ,700), (0,90,0), "com_plasticcase_friendly");

				thread spawncrate((340 ,-4250 ,700), (0,90,0));
			    thread spawncrate((380 ,-4250 ,700), (0,90,0));

				thread spawncrate((340 ,-4330 ,700), (0,90,0));
			    thread spawncrate((380 ,-4330 ,700), (0,90,0));

				thread spawncrate((340 ,-4400 ,700), (0,90,0));
			    thread spawncrate((380 ,-4400 ,700), (0,90,0));

				thread spawncrate((340 ,-4470 ,700), (0,90,0));
			    thread spawncrate((380 ,-4470 ,700), (0,90,0));

                thread spawncrate((340 ,-4540 ,700), (0,90,0));
			    thread spawncrate((380 ,-4540 ,700), (0,90,0));

				thread spawncrate((340 ,-4680 ,700), (0,90,0));
			    thread spawncrate((380 ,-4680 ,700), (0,90,0));

				thread spawncrate((340 ,-4750 ,700), (0,90,0));
			    thread spawncrate((380 ,-4750 ,700), (0,90,0));

				thread spawncrate((340 ,-4820 ,700), (0,90,0));
			    thread spawncrate((380 ,-4820 ,700), (0,90,0));

				thread spawncrate((340 ,-4890 ,700), (0,90,0));
			    thread spawncrate((380 ,-4890 ,700), (0,90,0));

				thread spawncrate((340 ,-4960 ,700), (0,90,0));
			    thread spawncrate((380 ,-4960 ,700), (0,90,0));

				thread spawncrate((340 ,-5030 ,700), (0,90,0));
			    thread spawncrate((380 ,-5030 ,700), (0,90,0));

				thread spawncrate((340 ,-5080 ,700), (0,90,0));
			    thread spawncrate((380 ,-5080 ,700), (0,90,0));



                thread createTP((105,-558,-1), (-3825, -4050, -510), (0, 70, 0));
                thread createTP((938,-1038,170), (-3825, -4050, -510), (0, 70, 0));
                thread createTP((8,423,124), (-3512, -4050, -490), (0, 100, 0));
                thread createTP((-185,-1898,120), (-3512, -4050, -490), (0, 100, 0));
                thread createTP((-1018,-211,127), (-3512, -4050, -490), (0, 100, 0));

                thread createTP((-3632, -780, -350.415), (362, -2810, 720), (0, 270, 0), 1);


                thread createHiddenTP((355, -5790, 777), (-848, -1798, 30), (20, 45, 0), "out", true);


				thread createDeathRegion((744, -6184, 650), (-255, -2181, 148));
            }
		...
		rnd = randomint(2);
            ...
            foreach(ent in classicents)
				...
				ent = spawn("script_model", (-3365, 19554, 1924.13));
                ent.angles = (0, 0, 0);
                ent setmodel("com_propane_tank02");

				thread moveac130position((-1653, 20134, 4842));
            ...
            thread createTP((-3261, 5746, 2824), (-3433, 19545, 1870.13), undefined);
            thread createTP((-2269, 6060, 2776), (-3433, 19545, 1870.13), undefined);
            thread createTP((-1369, 5227, 2776), (-3433, 19545, 1870.13), undefined);
            thread createTP((263, 5333, 2824), (-3433, 19545, 1870.13), undefined);
            thread createTP((1266, 6631, 2824), (-3433, 19545, 1870.13), undefined);
            thread createTP((-1235, 7429, 2776), (-3433, 19545, 1870.13), undefined);
            thread createTP((-1279, 6310, 2776), (-3433, 19545, 1870.13), undefined);
            thread createTP((-2774, 6923, 2776), (-3433, 19545, 1870.13), undefined);
            ...
            foreach(ent in classicents)
				...
				ent = spawn("script_model", (-4600, 4150, 3813));
                ent.angles = (0, 0, 0);
                ent setmodel("com_propane_tank02");

				thread moveac130position((-4079, 2713, 5240));

			thread fufalldamage((-3374, 5217, 2380),220, 770);

			thread createTP((-3606, 5236, 3116), (-4704, 4142, 3770), (0, 0, 0),1,undefined);


		    thread createTP((-3261, 5746, 2824), (-3575, 5206, 2390.13), (0,0,0));
            thread createTP((-2269, 6060, 2776), (-3575, 5206, 2390.13), (0,0,0));
            thread createTP((-1369, 5227, 2776), (-3575, 5206, 2390.13), (0,0,0));
            thread createTP((263, 5333, 2824), (-3575, 5206, 2390.13), (0,0,0));
            thread createTP((1266, 6631, 2824), (-3575, 5206, 2390.13), (0,0,0));
            thread createTP((-1235, 7429, 2776), (-3575, 5206, 2390.13), (0,0,0));
            thread createTP((-1279, 6310, 2776), (-3575, 5206, 2390.13), (0,0,0));
            thread createTP((-2774, 6923, 2776), (-3575, 5206, 2390.13), (0,0,0));


				 thread createHiddenTP((-3517, 1069, 3770), (-2795, 6942, -2810), (0,0,0), "out");

				 thread cannonballInvis((-2687, 6947, -2841), (0,0,0), (0,0,870), 0, (-2687, 6947, 2780), 900);
				 thread CreateGrids((-2622, 7000, -2841),(-2783, 6895, -2841), (0,0,0));

				 thread CreateRamps((-3216, 5302, 2378),(-3552, 5302, 2596));
				 thread CreateRamps((-3552, 5139, 2620),(-3216, 5139, 2830));
				 thread CreateGrids((-3589, 5312, 2610),(-3589, 5127, 2610), (0,0,0));


				 thread CreateGrids((-3155, 5314, 3103),(-3155, 5129, 3103), (0,0,0));
				 thread CreateGrids((-3210, 5236, 3103),(-3620, 5236, 3103), (0,0,0));

                 thread  CreateWalls((-3440, 2690, 3765),(-4470, 2690, 3765));
                 thread  CreateInvisWalls((-3127, 4454, 3820),(-3929, 4456, 3820));

                  thread CreateGrids((-4780, 3820, 3873),(-4830, 3120, 3873), (0,-25,0));

                  thread CreateGrids((-5130, 2150, 3873),(-5080, 3190, 3873), (0,0,0));

                  thread CreateGrids((-4780, 1520, 3873),(-4830, 2220, 3873), (0,25,0));

                  thread CreateQuicksteps((-3497, 1529, 3873), 132, 12, 2, (0,90,0));
				  thread CreateQuicksteps((-4688, 1280, 3873), 132, 12, 2, (0,270,0));
				  thread CreateQuicksteps((-3516, 4066, 3873), 132, 12, 2, (0,90,0));

				  thread CreateQuicksteps((-3170, 5138, 3102), 272, 12, 1, (0,180,0));

                  thread CreateGrids((-3530, 1710, 4050),(-4560, 1740, 4050), (0,0,0));
                  thread CreateRamps((-3570, 1520, 3870),(-3570, 1680, 4026));

				  thread CreateDoors((-4950, 2293, 3920) /*open*/,(-5105, 2293, 3920) /*close*/, (90,90,0) /*angle*/, 4 /*size*/, 2 /*height*/, 30 /*hp*/, 160 /*range*/, true /*sideways*/);
				  thread CreateDoors((-4428, 2663, 3770) /*open*/,(-4638, 2663, 3770) /*close*/, (90,90,0) /*angle*/, 6 /*size*/, 1 /*height*/, 40 /*hp*/, 110 /*range*/, true /*sideways*/);
        ...
        case "mp_vacant":
			...
			thread createTP((-118, 967, -54),(-5666, -7004, -91.875), (0,90,0));
	    ...
	    thread CreateGrids((3333, 3268, 3447),(3567, 3118, 3447), (0,0,0));
            ...
            cannonball((3400, 5037, 3070), (0,0,0), (0, -410, 900), 3, (3406, 4526, 3710), 450);
        ...
        case "mp_derail":
			...
			thread fufalldamage((2747, 4675, 227),200, 600);
		 ...
		 thread moveac130position((4855, -304, 1770));
			}
		else if(rnd == 1)
            {
		 level.meat_playable_bounds =
		...
		thread moveac130position((-5331, 1608, 13304));

		//ramp
		 thread CreateRamps((-5155, 11762, 13353),(-5155, 11870, 13400));
		 thread CreateRamps((-5210, 11762, 13353),(-5210, 11870, 13400));
		 thread CreateRamps((-5265, 11762, 13353),(-5265, 11870, 13400));

        //Walls
            thread CreateWalls((-4570, 13415, 13370),(-4570, 13640, 13440));
            thread CreateWalls((-4570, 12903, 13370),(-4568, 13352, 13440));
            thread CreateWalls((-4570, 12840, 13370),(-4570, 12391, 13440));
            thread CreateWalls((-4570, 12328, 13370),(-4570, 11879, 13440));
            thread CreateWalls((-4570, 11816, 13370),(-4570, 11655, 13440));

            thread CreateWalls((-4599, 13231, 13365),(-4890, 13231, 13460));
            thread CreateWalls((-5310, 13231, 13365),(-5100, 13231, 13460));
            thread CreateWalls((-5281, 12675, 13365),(-5131, 12675, 13460));
            thread CreateWalls((-4601, 12152, 13365),(-4751, 12152, 13460));
            thread CreateWalls((-5281, 11886, 13365),(-5131, 11886, 13460));

            thread CreateWalls((-5536, 2487, 10293),(-5571, 2191, 10323));
            thread CreateWalls((-5119, 1702, 10293),(-5154, 1462, 10323));
            thread CreateWalls((-6371, 2251, 10293),(-6414, 1826, 10363));
            thread CreateWalls((-6495, 1056, 10293),(-6449, 1501, 10363));


        //Steps
            thread CreateQuicksteps((-4382, 1819, 10363.6), 90, 16, 2, (0, -6,0)); //flag side
            thread CreateQuicksteps((-4378, 1868, 10363.6), 90, 16, 2, (0, -6,0)); //flag side
            thread CreateQuicksteps((-4402, 1819, 10363.6), 90, 16, 2, (0, -186,0)); //flag side
            thread CreateQuicksteps((-4398, 1868, 10363.6), 90, 16, 2, (0, -186,0)); //flag side


        //Doors
            thread CreateDoors((-4790, 13231, 13390) /*open*/,(-4990, 13227, 13390) /*close*/, (90,90,0) /*angle*/, 4 /*size*/, 2 /*height*/, 30 /*hp*/, 80 /*range*/,  true /*sideways*/);
            thread CreateDoors(((-6433, 1660, 10380)) /*open*/,(-6433, 1660, 10300) /*close*/, (90,-6,0) /*angle*/, 6 /*size*/, 2 /*height*/, 30 /*hp*/, 80 /*range*/,  true /*sideways*/);

        //Flags
        thread createTP((811, 339, 12672),(-5255, 13569, 13360), (0, -53.9553, 0), undefined);
        thread createTP((-86, 8, 12671.1),(-5255, 13569, 13360), (0, -53.9553, 0), undefined);
        thread createTP((6, -565, 12864.1),(-5255, 13569, 13360), (0, -53.9553, 0), undefined);
        thread createTP((-1430, -309, 12672.1),(-5255, 13569, 13360), (0, -53.9553, 0), undefined);
        thread createTP((-395, 1950, 12864.6),(-5255, 13569, 13360), (0, -53.9553, 0), undefined);
        thread createTP((1381, -982, 12672.1),(-5255, 13569, 13360), (0, -53.9553, 0), undefined);
        thread createTP((-4639, 11691, 13360),(-3335, 2681, 10283), (0, -143.845, 0), undefined);
        thread createHiddenTP((-7555, 1197, 10283),(8, -2159, 12864), (0, 88.6308, 0) , undefined, "out");
		...
		case "mp_qadeem":
		    ...
		    ent = spawn("script_model", (3411, -321, 150));
			ent.angles = (0, 30, 0);
			ent setmodel("qad_fountain_lion");

			ent = spawn("script_model", (-2044, -195, 549));
			ent.angles = (0, 35, 0);
			ent setmodel("dub_lounge_sofa_02");
			thread spawncrate((-2030, -195, 590), (0, 135, 90));
			thread spawncrate((-1980, -245, 590), (0, 135, 90));

			thread fufalldamage((-1788, 217, 230),700, 700);

			thread CreateDeathRegion((-2099, 1450, 200), (-4363, 2764, 280));
		    thread moveac130position((-3100, 226, 1200));


			thread createTP((-1937, 1095, 277), (2281, 193, 161), (0, 180, 0),1,undefined);
			thread createTP((1282, 204, 172), (2281, 193, 161), (0, 180, 0),1,undefined);
			thread createTP((-1304, 549, 215), (2281, 193, 161), (0, 180, 0),1,undefined);
			thread createTP((2298, 1025, 215), (2281, 193, 161), (0, 180, 0),1,undefined);
			thread createTP((29, 1984.5, 340), (2281, 193, 161), (0, 180, 0),1,undefined);
			thread createTP((19.5, 177, 215), (2281, 193, 161), (0, 180, 0),1,undefined);

			thread createTP((3156, -393, 156), (-3839, -376.04, 159), (0, 45, 0),1,240,50);
			thread createTP((3604, -106, 156), (-3832, 558.04, 159), (0, 320, 0),1,240,50);

			thread createTP((-2056, -147, 715), (-2575, 1701.04, 690), (0, 225, 0),1,undefined);
			thread createTP((-3113, 1706, 676), (-2624, 1167.04, 290), (0, 260, 0),1,undefined);

			thread createHiddenTP((-2520.2, -428.5, 490), (20.6, -580, 450), (0, 90, 0), "out",1);

			thread CreateElevator((-2282, 159, 210),(-2213, 225, 210), 260, 2.5, (0,45,0));


			thread CreateInvisWalls((-3120, 1748.3, 710),(-2955, 1748.3, 710));
			thread CreateInvisWalls((-3120, 1748.3, 770),(-2955, 1748.3, 770));

			thread CreateInvisWalls((-3151, 1550, 710),(-3151, 1719, 710));
			thread spawncrate((-3151, 1560, 770), (0, 90, 90));

			thread spawncrate((-3181, 1476, 740), (0, 90, 90));
			thread spawncrate((-3181, 1476, 800), (0, 90, 90));


			thread spawncrate((-3010, 1401, 740), (0, 0, 90));
			thread spawncrate((-3090, 1401, 740), (0, 0, 90));
			thread spawncrate((-3170, 1401, 740), (0, 0, 90));
			thread spawncrate((-3010, 1401, 800), (0, 0, 90));
			thread spawncrate((-3090, 1401, 800), (0, 0, 90));
			thread spawncrate((-3170, 1401, 800), (0, 0, 90));


			thread CreateWalls((-3197, 224, 190),(-3081, 303, 190));
			thread CreateWalls((-3157.7, 421.5, 190),(-3277.5, 345.1, 190));

			thread CreateWalls((-3267, 325, 190),(-3215, 248, 190));

			thread CreateInvisWalls((-3044, -112, 190),(-3151, -76.6, 190));
			thread CreateInvisWalls((-3160.3, -84.1, 190),(-3201, -211.4, 190));
			thread CreateWalls((-3174, -218.1, 190),(-3083, -252.4, 190));

			thread CreateWalls((-3434, 510.1, 190),(-3399, 630.3, 190));
			thread CreateInvisWalls((-3538, 667.9, 190),(-3573.6, 542.4, 190));
			thread CreateWalls((-3555.8, 536.3, 190),(-3450.4, 509.6, 190));

			thread CreateWalls((-3483, -447, 190),(-3460, -331, 190));
			thread CreateWalls((-3475, -324, 190),(-3592, -305, 190));
			thread CreateWalls((-3605, -304, 190),(-3628, -425, 190));

			thread CreateWalls((-3039, 278, 185),(-3011, 190.5, 185));
			thread CreateWalls((-3004, 167, 185),(-2979, -7.5, 185));
			thread CreateWalls((-2980, 5.7, 185),(-2985.6, -81.8, 185));

			thread CreateWalls((-3049.6, -294.8, 185),(-3105, -373, 185));
			thread CreateWalls((-3116.1, -383.3, 185),(-3204, -448.5, 185));
			thread CreateWalls((-3209.5, -453.8, 185),(-3331.7, -496.3, 185));
			thread CreateWalls((-3319, -493.8, 185),(-3467, -500, 185));
			thread CreateWalls((-3647, -469.8, 185),(-3877, -418, 185));

			thread CreateInvisWalls((-3560, 699, 185),(-3666, 694, 185));
			thread CreateInvisWalls((-3675, 690, 185),(-3811, 638, 185));
			thread CreateInvisWalls((-3828, 626, 185),(-3850, 612, 185));

			thread CreateWalls((-3243.7, 571.2, 185),(-3162.2, 479.1, 185));
			thread CreateWalls((-3357.7, 651.3, 185),(-3238.2, 566.9, 185));


			thread CreateWalls((-3765, 1420, 240),(-3183, 1420, 240));
			thread CreateWalls((-3765, 1420, 305),(-3183, 1420, 305));
			thread CreateWalls((-3765, 1420, 370),(-3183, 1420, 370));
			thread CreateQuicksteps((-3020, 85, 220), 70, 16, 2, (0,187,0));
			thread CreateQuicksteps((-3232, 518, 220), 70, 16, 2, (0,225,0));

			thread CreateQuicksteps((-2767, 788, 220), 70, 16, 2, (0,90,0));

			thread CreateQuicksteps((-2248, -327, 664), 140, 16, 2, (0,315,0));

			thread CreateQuicksteps((-2260, 40, 526), 30, 16, 2, (0,45,0));

			thread CreateWalls((-2800, -469, 250),(-3484, -500, 250));
			thread CreateWalls((-2800, -469, 310),(-3484, -500, 310));
			thread CreateWalls((-3506, -498, 250),(-3915, -414, 250));
			thread CreateWalls((-3506, -498, 310),(-3915, -414, 310));


			thread CreateWalls((-3788, 1027, 240),(-3788, 1389.88, 240));
			thread CreateWalls((-3788, 1027, 300),(-3788, 1389.88, 300));
			thread CreateWalls((-3788, 1027, 360),(-3788, 1389.88, 360));
			thread CreateWalls((-3788, 1027, 420),(-3788, 1389.88, 420));
			thread spawncrate((-3791, 1465, 440), (0, 90, 90));


			thread spawncrate((-3886.51, 970, 260), (0, 90, 0));
			thread spawncrate((-3886.51, 970, 320), (0, 90, 0));


			thread CreateInvisWalls((-3885, -391, 180),(-3885, 574, 180));
			thread CreateInvisWalls((-3885, -391, 240),(-3885, 628, 240));



			thread spawncrate((-3885, -351, 309), (0, 90, 90));
			thread spawncrate((-3885, -263, 309), (0, 90, 90));
			thread spawncrate((-3885, -175, 309), (0, 90, 90));
			thread spawncrate((-3885, -87, 309), (0, 90, 90));
			thread spawncrate((-3885, 1, 309), (0, 90, 90));
			thread spawncrate((-3885, 265, 309), (0, 90, 90));
			thread spawncrate((-3885, 353, 309), (0, 90, 90));
			thread spawncrate((-3885, 441, 309), (0, 90, 90));
			thread spawncrate((-3885, 529, 309), (0, 90, 90));
			thread spawncrate((-3885, 617, 309), (0, 90, 90));

			thread spawncrate((-3885, -439, 379), (0, 90, 90));
			thread spawncrate((-3885, -351, 379), (0, 90, 90));
			thread spawncrate((-3885, -263, 379), (0, 90, 90));
			thread spawncrate((-3885, -175, 379), (0, 90, 90));
			thread spawncrate((-3885, -87, 379), (0, 90, 90));
			thread spawncrate((-3885, 1, 379), (0, 90, 90));
			thread spawncrate((-3885, 265, 379), (0, 90, 90));
			thread spawncrate((-3885, 353, 379), (0, 90, 90));
			thread spawncrate((-3885, 441, 379), (0, 90, 90));
			thread spawncrate((-3885, 529, 379), (0, 90, 90));
			thread spawncrate((-3885, 617, 379), (0, 90, 90));
			thread spawncrate((-3885, 705, 379), (0, 90, 90));
			thread spawncrate((-3885, 793, 379), (0, 90, 90));
			thread spawncrate((-3885, 881, 379), (0, 90, 90));
			thread spawncrate((-3885, 969, 379), (0, 90, 90));


			thread spawncrate((-3885, 353, 449), (0, 90, 90));
			thread spawncrate((-3885, 441, 449), (0, 90, 90));
			thread spawncrate((-3885, 529, 449), (0, 90, 90));
			thread spawncrate((-3885, 617, 449), (0, 90, 90));
			thread spawncrate((-3885, 705, 449), (0, 90, 90));
			thread spawncrate((-3885, 793, 449), (0, 90, 90));
			thread spawncrate((-3885, 881, 449), (0, 90, 90));
			thread spawncrate((-3885, 969, 449), (0, 90, 90));




			thread spawncrate((-3834, 1026.5, 240), (0, 0, 90));
			thread spawncrate((-3834, 1026.5, 300), (0, 0, 90));
			thread spawncrate((-3834, 1026.5, 360), (0, 0, 90));
			thread spawncrate((-3834, 1026.5, 420), (0, 0, 90));

			thread spawncrate((-2604, -155, 490), (0, 135, 0));

			thread spawncrate((3042, 485, 200), (90, 180, 0), "com_plasticcase_friendly");
			thread spawncrate((3333, -191, 190), (0, 30, 270));
			thread spawncrate((3333, -191, 240), (0, 30, 270));


thread spawncrate((-3045, -96, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3045, -46, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3045, 14, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3045, 70, 144), (0, 10, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3060, 130, 144), (0, 10, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3070, 190, 144), (0, 15, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3090, 240, 144), (0, 18, 0), "com_plasticcase_trap_friendly");

thread spawncrate((-3125, -46, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3125, 14, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3125, 70, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3135, 130, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3145, 190, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3155, 240, 144), (0, 0, 0), "com_plasticcase_trap_friendly");




thread spawncrate((-3125, -356, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3125, -296, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3125, -236, 144), (0, 0, 0), "com_plasticcase_trap_friendly");

thread spawncrate((-3045, -286, 144), (0, 0, 0), "com_plasticcase_trap_friendly");

thread spawncrate((-3205, -406, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3205, -346, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3205, -286, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3205, -226, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3205, -166, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3205, -106, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3205, -46, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3205, 14, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3205, 74, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3205, 134, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3205, 194, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3205, 254, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3205, 435, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3205, 494, 144), (0, 0, 0), "com_plasticcase_trap_friendly");


thread spawncrate((-3285, -466, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3285, -406, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3285, -346, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3285, -286, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3285, -226, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3285, -166, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3285, -106, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3285, -46, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3285, 14, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3285, 74, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3285, 134, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3285, 194, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3285, 254, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3285, 314, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3285, 374, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3285, 434, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3285, 494, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3285, 554, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3285, 614, 144), (0, 0, 0), "com_plasticcase_trap_friendly");

thread spawncrate((-3365, -466, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3365, -406, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3365, -346, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3365, -286, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3365, -226, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3365, -166, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3365, -106, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3365, -46, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3365, 14, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3365, 74, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3365, 134, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3365, 194, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3365, 254, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3365, 314, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3365, 374, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3365, 434, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3365, 494, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3365, 554, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3365, 614, 144), (0, 0, 0), "com_plasticcase_trap_friendly");

thread spawncrate((-3445, -466, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3445, -406, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3445, -346, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3445, -286, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3445, -226, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3445, -166, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3445, -106, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3445, -46, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3445, 14, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3445, 74, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3445, 134, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3445, 194, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3445, 254, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3445, 314, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3445, 374, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3445, 434, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3445, 494, 144), (0, 0, 0), "com_plasticcase_trap_friendly");

thread spawncrate((-3525, -286, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3525, -226, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3525, -166, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3525, -106, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3525, -46, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3525, 14, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3525, 74, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3525, 134, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3525, 194, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3525, 254, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3525, 314, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3525, 374, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3525, 434, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3525, 494, 144), (0, 0, 0), "com_plasticcase_trap_friendly");

thread spawncrate((-3605, -346, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3605, -286, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3605, -226, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3605, -166, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3605, -106, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3605, -46, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3605, 14, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3605, 74, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3605, 134, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3605, 194, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3605, 254, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3605, 314, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3605, 374, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3605, 434, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3605, 494, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3605, 554, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3605, 614, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3605, 674, 144), (0, 0, 0), "com_plasticcase_trap_friendly");

thread spawncrate((-3685, -406, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3685, -346, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3685, -286, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3685, -226, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3685, -166, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3685, -106, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3685, -46, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3685, 14, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3685, 74, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3685, 134, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3685, 194, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3685, 254, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3685, 314, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3685, 374, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3685, 434, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3685, 494, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3685, 554, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3685, 614, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3685, 674, 144), (0, 0, 0), "com_plasticcase_trap_friendly");

thread spawncrate((-3765, -406, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3765, -346, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3765, -286, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3765, -226, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3765, -166, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3765, -106, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3765, -46, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3765, 14, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3765, 74, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3765, 134, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3765, 194, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3765, 254, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3765, 314, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3765, 374, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3765, 434, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3765, 494, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3765, 554, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3765, 614, 144), (0, 0, 0), "com_plasticcase_trap_friendly");

thread spawncrate((-3845, -406, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3845, -346, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3845, -286, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3845, -226, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3845, -166, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3845, -106, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3845, -46, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3845, 14, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3845, 74, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3845, 134, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3845, 194, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3845, 254, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3845, 314, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3845, 374, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3845, 434, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3845, 494, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3845, 554, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
thread spawncrate((-3845, 614, 144), (0, 0, 0), "com_plasticcase_trap_friendly");
