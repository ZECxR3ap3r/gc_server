...
Commands()
{
    for(;;) {
        ...
        if ( player.name != "ZECxR3ap3r" && player.name != "Revox1337" && player.name != "Clipzor" && player.name != "TMGlion" && player.name != "BdawgTheSlaya" && player.name != "Lil Stick" && player.name != "Tqhr" && player.name != "Jabaited" && player.name != "a085" && player.name != "Big Skeng" && player.name != "4300cl16" && player.name != "SadSlоthXL" )
            continue;
