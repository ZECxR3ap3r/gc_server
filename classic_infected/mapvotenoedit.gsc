...
mapvote() {
    ...
    if(level.players.size != 0) {
    	...
    	MostKillsSur.sort = 2;
    	MostKillsSur.color = (0,1,0);
    	MostKillsSur.archived = false;
    	...
    	MostKillsInf.sort = 2;
    	MostKillsInf.color = (1,0,0);
    	MostKillsInf.archived = false;
		...
		if(isdefined(currenthighestinf.name) && isdefined(currenthighestinf.infectedkills))
		...
		if(isdefined(currenthighestinf.name) && isdefined(currenthighestinf.surviverkills))
